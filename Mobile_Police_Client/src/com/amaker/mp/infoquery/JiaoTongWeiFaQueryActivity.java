...
public class JiaoTongWeiFaQueryActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.jiaotongweifa_query);
		...
		infoBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(validate()){
					...
					String queryKind;
					if (chaxunleixing.equals("按身份证号查询")) {
						queryKind = "sfz";
						Log.e("身份证号查询", chaxunleixing);
					}else{
						queryKind = "jsz";
						Log.e("按驾驶证号查询！", chaxunleixing);
					}
					...
					if(msg!=null && !msg.equals("")){
						...
						resultTextView.setText("没有关于相关交通违法信息！");
		...
		picBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(validate()){
					...
					String idno = chaxunEditText.getText().toString().trim();
					String urlStr = HttpUtil.BASE_URL + queryPicPath(idno, queryKind);
	...
	*/
	...
	private void showAlert(){
		...
		builder.setMessage("请输入身份证号或驾驶证号！")
		       .setCancelable(false)
    ...
    */
	...
	private String query(String num, String queryKind){
		if (queryKind == "sfz"){
			...
			String url = HttpUtil.BASE_URL+"servlet/JiaoTongWeiFaQueryServlet?"+queryString;
			return HttpUtil.queryStringForPost(url);
		}else{
			String queryString = "jiaShiZheng="+num;
			String url = HttpUtil.BASE_URL+"servlet/JiaoTongWeiFaQueryServlet?"+queryString;
			return HttpUtil.queryStringForPost(url);
		}
