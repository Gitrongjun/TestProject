...
public class UploadAudioActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		selectBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(UploadAudioActivity.this,FileExplorerActivity.class);
		...
		submitBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(!validate(fileName)){
					showAlert("无效语音文件，允许的格式为MP3，WMA, WAV，请检查！");
				}else{
	...
	private String uploadFile(String fileName){
		String urlStr = HttpUtil.BASE_URL+"servlet/UploadAudioServlet";
		String newName="audio.mp3";
		String end = "\r\n";
	    String twoHyphens = "--";
	    String boundary = "*****";
	    try
	...
	private boolean validate(String fileName){
		...
		if(subfix.equals(".mp3")||subfix.equals(".wav")||subfix.equals(".wma")){
			return true;
		}else{
			return false;
		}
