...
public static void main(String[] args) throws Exception {
		...
		cap.setCapability("appPackage", "com.miui.calculator");//被测app的包名
		cap.setCapability("appActivity",".cal.CalculatorActivity");//被测app的入口Activity名称
	...
	public static  String[] getFileName(){
		File file =new File("D:\\temp\\qudaobao");
